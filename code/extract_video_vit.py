...
feature_extractor = ViTFeatureExtractor.from_pretrained("/root/autodl-tmp/code/googlevit-base-patch16-224-in21k")
vit_model = ViTModel.from_pretrained("/root/autodl-tmp/code/googlevit-base-patch16-224-in21k").to(device)
    ...
    for subfolder in os.listdir(video_root_dir):
        ...
        if os.path.isdir(subfolder_path):  # Check if it's a directory
            for video_file in os.listdir(subfolder_path):
                ...
                output_path = f'/root/autodl-tmp/features/VIT_features/{subfolder}/{video_name}.p'
...
if __name__ == "__main__":
    video_root_dir = '/root/autodl-tmp/PCLMM'  # Root directory containing subfolders with video files
